...
\firstpageheader{\textsc{bi} 300: Evolution}{}{\ifprintanswers\textbf{KEY}\else Name: \enspace \makebox[2.5in]{\hrulefill}\fi}
...
\question[5]
The Hardy-Weinberg equations have five assumptions. List them; you do not have to explain them.
