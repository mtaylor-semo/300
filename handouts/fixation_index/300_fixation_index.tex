...
\begin{questions}
	...
	\begin{multicols}{2}
		...
		\begin{tabular}{rcccc}
			\toprule
			& \ifprintanswers$c_i$\else$N$\fi & $p$ & $q$ & \ifprintanswers $c_i2p_iq_i$\else \phantom{fred}\fi \tabularnewline
			\midrule
			A & \ifprintanswers0.5 \else 50\fi & 0.44 & 0.56 &  \ifprintanswers 0.2464 \fi \tabularnewline
			B & \ifprintanswers0.5 \else 50\fi & 0.72 & 0.28 & \ifprintanswers 0.2016 \tabularnewline
			\bottomrule
...
\ifprintanswers  As above, but $c_i$ for each pop is 0.25.
